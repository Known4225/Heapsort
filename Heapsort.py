...
turtle.setup(1000, 810)
turtools = turtleTools(turtle.getcanvas(), -500, -405, 500, 405, True)
t = turtle.Turtle()
t.speed(0)
t.hideturtle()
t.penup()
...
def wait(kl):
    while not turtools.keyPressed(' '):
        turtle.update()
        t.goto(0, 0)
    while turtools.keyPressed(' '):
        turtle.update()
        t.goto(0, 0)
    # i = 0
    # while 2 * i + 2 < len(ar):
...
print('Press space to advance animation')
print('Array:')
print(array)
drawArray(array, 350)
yset = 280
